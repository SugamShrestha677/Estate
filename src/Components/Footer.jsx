...
const Footer = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <p className="text-slate-200 text-justify ">
            ...
            eum nemo nesciunt quae voluptatibus nisi eligendi, cupiditate
            laboriosam vero.
          </p>
          ...
          >
            ...
            <div className="p-3 rounded-xl bg-white hover:bg-red-600 hover:text-white cursor-pointer transform hover:scale-110 transition-transform duration-300">
              <FaFacebookF className="sixe-5" />
            </div>
            <div className="p-3 rounded-xl bg-white hover:bg-red-600 hover:text-white cursor-pointer transform hover:scale-110 transition-transform duration-300">
              <FaInstagram className="sixe-5" />
            </div>
            <div className="p-3 rounded-xl bg-white hover:bg-red-600 hover:text-white cursor-pointer transform hover:scale-110 transition-transform duration-300">
              <FaTwitter className="sixe-5" />
            </div>
            <div className="p-3 rounded-xl bg-white hover:bg-red-600 hover:text-white cursor-pointer transform hover:scale-110 transition-transform duration-300">
              <FaYoutube className="sixe-5" />
            </div>
          </div>

          <h1 className="text-white mt-8 mb-8">
            Copyright Real Estate, All Rights Reserverd
          </h1>
        </div>
        ...
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-3 ">
            ...
            <p className="text-slate-200 ">+977 9876543210</p>
          </div>
          <div className="flex justify-center items-center gap-3 ">
            <FaFax className="text-white size-5" />
            <p className="text-slate-200 ">887 766 55</p>
          </div>
          <div className="flex justify-center items-center gap-3 ">
            <IoMdMail className="text-white size-5" />
            <p className="text-slate-200 ">demomail@gmai.com</p>
          </div>
        </div>
      ...
      <div
        id="icon-box"
        className="bg-red-600 p-4 rounded-full cursor-pointer hover:bg-black fixed lg:bottom-12 bottom-6 right-6 "
      >
