        ...
        >
          {client.map((item, index) => (
            <div
              ...
              data-aos-delay="200"
              key={index}
              className={`${darkMode ? 'bg-gray-900' : 'bg-white'} hover:bg-red-100 cursor-pointer p-12 flex flex-col justify-center items-center gap-6 rounded-xl w-full`}
            >
              <div className="flex justify-start items-center w-full gap-4">
                ...
                <div className="flex flex-col justify-center items-start gap-1 ">
                  ...
                  <h1 className={`${darkMode ? 'text-white' : 'text-slate-600'}`}>{item.text}</h1>

                </div>
              </div>
{/* Feedback */}
              <p className={`text-md text-justify ${darkMode ? 'text-white' : 'text-slate-600'}`}>{item.feedback}</p>
{/* Icons */}
